...
def triangle(angle1, angle2, angle3)
  arr_angles = [angle1, angle2, angle3]
  return :invalid if arr_angles.any?(0) || arr_angles.sum != 180
  return :right   if arr_angles.include?(90)
  return :acute   if arr_angles.max < 90
  return :obtuse  if arr_angles.max > 90
end
